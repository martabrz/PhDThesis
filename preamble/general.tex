...
\usepackage{floatrow}
\usepackage{caption}
\captionsetup{format=hang,font=small,labelfont={bf},margin=5pt}
\usepackage{subcaption}
\captionsetup[sub]{margin=0pt,font=small,labelfont={bf}}
...
\hypersetup{%
  ...
  pdfsubject={},%
  pdfkeywords={topological materials},%
  pdflang={en},%
}
...
\titleformat{\chapter}[display]%
  {\relax}{\vspace*{-3\baselineskip}\makebox[\linewidth][r]{\color{halfgray}\chapterNumber\thechapter}}{11pt}%
  {\bf\raggedright\spacedallcaps}[\large\vspace*{.8\baselineskip}\color{black}\titlerule]%
...
% CV
\newcommand{\cvleft}[1]{\hspace*{-0.0cm}\begin{minipage}[t]{3cm}\begin{flushright}#1\end{flushright}\end{minipage}\hspace{5mm}}
\newcommand{\cvright}[1]{\begin{minipage}[t]{11.2cm}{#1}\end{minipage}}
